# spec_hash: a230ef9d9a624b0cd7acaa3da9063bcca4416cf46c2a53b9d9064f6c3acde64b
...
"""Silver -> Gold transform for `supplier_lead_times`."""
...
def run_glue_spark():  # pragma: no cover
    ...
    try:
        from workloads.supplier_lead_times.scripts.transform import spark_transforms
    except ImportError:
...
if __name__ == "__main__":
    ...
    ap.add_argument("--silver", default="output/supplier_lead_times/silver/silver_supplier_lead_times.parquet")
