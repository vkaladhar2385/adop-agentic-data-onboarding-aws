# spec_hash: 45d977117272a20ef399b07ac9f47ad6ce871cd46a94d88778d96765b42febaf
...
"""Bronze ingestion for `customer_orders`. Bronze is never transformed."""
...
try:
    from workloads.customer_orders.scripts.transform.local_runner import ingest_bronze
except ImportError:
...
def run_local(source_path: str, out_dir: str) -> str:
    ...
    target = out / "bronze_customer_orders.parquet"
...
def run_glue():  # pragma: no cover
    ...
    target = bronze_path.rstrip("/") + "/bronze_customer_orders.parquet"
...
if __name__ == "__main__":
    ...
    ap.add_argument("--source", default="demo/sample_data/customer_orders.csv")
