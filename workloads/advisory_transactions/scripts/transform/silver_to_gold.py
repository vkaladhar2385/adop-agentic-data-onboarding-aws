# spec_hash: c8bcb444d549a3503f053ede1e7337950dd2248bb3e5ff9e557da45babcbbe5f
# template_id: silver_to_gold
# template_hash: 1816c5c2bef086b27a16dcbca0996633fecdc9e3d2adc150bc895adb6421a748
# schema_version: v1
# rendered_at: 2026-09-09T18:51:33Z
...
def run_glue_spark():  # pragma: no cover
    ...
    try:
        from workloads.advisory_transactions.scripts.transform import spark_transforms
    except ImportError:
